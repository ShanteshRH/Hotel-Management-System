...
if not is_authenticated:
    ...
    selected_option = st.selectbox("Options", ["Home","User Management","Display","Insert", "Update", "Delete","Join","Payment detail for each reservation","Guest stay details","Check guest details"])
    ...
    elif selected_option == "Check guest details":
       check_guest_details() 
connection.close()