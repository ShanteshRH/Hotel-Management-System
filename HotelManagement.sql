...
INSERT INTO User VALUES (1,'Shantesh','Shan@123','admin');
INSERT INTO Guest VALUES('G01','Shantesh R Hosmath','Like Home PG,Besides PES University Back Gate,Dwaraka Nagar,Bengaluru','9036130794',20),
						('G02','Rahul S Nayak','Maruti PG,Besides PES University Back Gate,Dwaraka Nagar,Bengaluru','90561307286',25),
                        ('G03','Sanchay S Shetty','Akshay PG,Besides PES University Back Gate,Dwaraka Nagar,Bengaluru','9033134774',29),
...
INSERT INTO Staff VALUES('S01','Ramesh Sharma',35,'Housekeeping',12000.00),
                        ...
                        ('S03','Kiran Kumar',33,'Waiter',12000.00),
...
INSERT INTO Booking VALUES  ('B001','R001','SER01','2023-11-05',4),
							('B002','R001','SER05','2023-11-05',4),
							('B003','R001','SER06','2023-11-05',4),
                            ('B005','R003','SER01','2023-11-05',4),
                            ('B006','R003','SER02','2023-11-05',4),
                            ('B007','R003','SER03','2023-11-05',4),
                            ('B008','R004','SER01','2023-11-05',2),
                            ('B009','R004','SER05','2023-11-05',2),
							('B010','R005','SER01','2023-11-05',4),
                            ('B011','R005','SER05','2023-11-05',4);
                            
INSERT INTO Payments VALUES  ('P01','R001',10000.00,'2023-11-05','Credit/Debit Card'),
							('P02','R002',8000.00,'2023-11-05','UPI'),
                            ('P03','R003',10000.00,'2023-11-08','UPI'),
                            ('P04','R004',8000.00,'2023-11-09','Cash'),
                            ('P05','R005',6000.00,'2023-11-03','Credit/Debit Card');
...
-- drop procedure grant_admin_role;
